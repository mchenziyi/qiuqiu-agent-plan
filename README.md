...
- [AI Agent 简介](https://www.runoob.com/ai-agent/ai-agent-intro.html) — 介绍 Agent 是什么
- [AI Agent 核心组件](https://www.runoob.com/ai-agent/ai-agent-core.html) — 大脑、工具、记忆、规划（餐厅类比非常形象）
- 同一个站点还有底层架构（提示词工程、Token、RAG）、Agent 架构、工具开发、Claude Code、MCP 等内容，**后续阶段也都能用上**

### 英文参考

- [Anthropic Tool Use 概述](https://docs.anthropic.com/en/docs/build-with-claude/tool-use)
